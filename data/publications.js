/**
 * Liste complete des publications, groupees par annee.
 *
 * Champ `axes` : numeros des axes de recherche (1-4) auxquels la
 * publication se rattache, dans l'ordre de pertinence. Voir
 * themesRecherche dans data/site.js. Tableau vide = hors programme,
 * auquel cas `categorie` porte une etiquette transversale.
 */
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        type: "Livre",
        axes: [],
        categorie: { fr: "Formation à la recherche", en: "Research training" },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        type: "Article",
        axes: [],
        categorie: { fr: "Analyse spatiale appliquée", en: "Applied spatial analysis" },
